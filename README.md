...
adding alt text that accurately describes what an image is, so that people who can't see the image can still get a summary of what's on the page.

use semantic html structure so the page is easier to navigate for a screen reader.

add important info to the top. this makes it easier to access without having to navigate the entire page first.

3. How would you explain the concept of a variable to someone new to programming?

a variable is a container that you can assign data too. the data is then stored inside that variable the same way you would keep shoes in a shoebox.

4. What is the purpose of using functions in code?

a function is used when you want a specific block of code to do something and you want to be able to use that same block over again.
