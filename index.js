...
function getArtistByIndex(array, index) {
  return console.log("The artist at index " + array[index].id + " is " + array[index].name + ".")
}
...
let newArray = array.filter(function (e) {
    return e.years.substring(0, 4) > "1899";
});
...
console.log(addArtist(artists, 20, 'Danny', "1987 - ",'vorticist', 'martian', "I am not here"));
